...
$qqcookie	 = daddslashes($userrow['qqcookie']);
...
$q=file_get_contents("http://".$_SERVER['HTTP_HOST']."/corn/qqpayjine.php?id=$pid");
?>
<!DOCTYPE html>
<html>
<head>
    <iframe src="/corn/qqpaycorn.php?lf=<?php echo $money ?>&id=<?php echo $pid ?>" width="1" height="1"></iframe>
    <iframe src="/corn/qqpaycorn1.php?lf=<?php echo $money ?>&id=<?php echo $pid ?>" width="1" height="1"></iframe>
    ...
    <title>在线支付- QQ - <?php echo $sitename?></title>
    <style type="text/css">
        @font-face {
    ...
    <div class="container" style="position: relative;">
        ...
        <div id="root" style="text-align:center;">
            <center>
                <div class="body">
                   <h1 class="mod-title">
                <div class="casher-title"><img id="casherTitleImg" alt="img" src="/submit/Mcode/img/qqpay.jpg"
                </div>
                </div>
                </div>
                <div id="bgMain" class="pay-alipay">
                    <div class="qr-con">
                        ...
                        <div>
                            ...
                            <span id="1checkOrder" trade_no="<?php echo $trade_no ?>" style="font-size: 18px;color:#fff;cursor:pointer;background:#428bca;width:200px;display:inline-block;padding:5px;border-radius:5px">检测当前订单状态</span>
                                <div>
                                    <a id='okpay' href="mqqwpa://"
                                        style="color: #fff;text-decoration: none; text-align: center;padding: .55rem 0; display: inline-block; width: 65%; border-radius: .5rem; font-size: 16px;background-color: #428bca; border: 1px solid #428bca;letter-spacing:normal;font-weight: normal"
                                        class='action'>启动QQ(推荐)</a>
