                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">额度充值</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">额度</li>
                                    </ol>
                                </div>
                            ...
                            <div class="p-4 directory-content">
                                ...
                                <div class="media">
                                    <div class="media-body text-white" >
                                        ...
                                        <p class="font-600">
                                            <button type="button" class="btn btn-danger btn-sm waves-effect waves-light">
                                                <font  id="vipprice_5"><?php echo $conf['edtc2jg']; ?></font>元
                                            </button>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="p-4 directory-content">
                                ...
                                <div class="media">
                                    <div class="media-body text-white" >
                                        ...
                                        <p class="font-600">
                                            <button type="button" class="btn btn-danger btn-sm waves-effect waves-light">
                                                <font  id="vipprice_6"><?php echo $conf['edtc3jg']; ?></font>元
                                            </button>
                                        </p>
                                    </div>
                                </div>
...
微信免挂｜支付宝免挂｜QQ免挂                                </div>
                    ...
                    <div class="col-lg-4 col-md-6" style="cursor: pointer" onclick="type_4();">
                        <div class="card directory-card">
                            <div class="p-4 directory-content">
                                ...
                                <div class="media">
                                    <div class="media-body text-white" >
                                        ...
                                        <p class="font-600">
                                            <button type="button" class="btn btn-danger btn-sm waves-effect waves-light">
                                                <font  id="vipprice_7"><?php echo $conf['edtc4jg']; ?></font>元
                                            </button>
                                        </p>
                                    </div>
                                </div>
...
//product type
function type_1(){
		var r = confirm("充值<?php echo $conf['edtc1ed']; ?>额度，需支付<?php echo $conf['edtc1jg']?>元！");
	if(r==true){
		window.location.href ='./payapi.php?WIDsubject=充值额度|<?php echo $pid?>&WIDtotal_fee=<?php echo $conf['edtc1jg']?>&type=<?php echo $conf['cztype']?>';
	};
};
function type_2(){
	var r = confirm("充值<?php echo $conf['edtc2ed']; ?>额度，需支付<?php echo $conf['edtc2jg']?>元！");
	if(r==true){
		window.location.href ='./payapi.php?WIDsubject=充值额度|<?php echo $pid?>&WIDtotal_fee=<?php echo $conf['edtc2jg']?>&type=<?php echo $conf['cztype']?>';
	};
};
function type_3(){
	var r = confirm("充值<?php echo $conf['edtc3ed']; ?>额度，需支付<?php echo $conf['edtc3jg']?>元！");
	if(r==true){
		window.location.href ='./payapi.php?WIDsubject=充值额度|<?php echo $pid?>&WIDtotal_fee=<?php echo $conf['edtc3jg']?>&type=<?php echo $conf['cztype']?>';
	};
};
function type_4(){
	var r = confirm("充值<?php echo $conf['edtc4ed']; ?>额度，需支付<?php echo $conf['edtc4jg']?>元！");
	if(r==true){
		window.location.href ='./payapi.php?WIDsubject=充值额度|<?php echo $pid?>&WIDtotal_fee=<?php echo $conf['edtc4jg']?>&type=<?php echo $conf['cztype']?>';
	};
};
</script>
