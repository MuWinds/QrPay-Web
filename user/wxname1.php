...
$shopname2 = "$nameid(**$zsnamea)";
	$userrow=$DB->query("SELECT * FROM pay_user WHERE pid='{$pid}' limit 1")->fetch();
		...
		$sds=$DB->query("update pay_user set shopname2='$shopname2'  where pid='{$pid}'");
		if($sds)echo'<script>alert("修改成功");location.href="./wxname1.php"</script>';
		else echo'<script>alert("修改失败");location.href="./wxname1.php"</script>';
...
<div class="content-page">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form class="form-horizontal devform" action="./wxname1.php?mod=pay_n" method="post">
