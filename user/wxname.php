...
$shopname = "$nameid(**$zsnamea)";
	$userrow=$DB->query("SELECT * FROM pay_user WHERE pid='{$pid}' limit 1")->fetch();
		...
		if($sds)echo'<script>alert("修改成功");location.href="./wxname.php"</script>';
		else echo'<script>alert("修改失败");location.href="./wxname.php"</script>';
...
<div class="content-page">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form class="form-horizontal devform" action="./wxname.php?mod=pay_n" method="post">
			
		
				<div class="form-group">
			 <div class="layui-card-header">设置说明</div>
      <div class="layui-card-body">
          配置之前请联系客服添加微信邀请店员在填写
          <small style="color: red">(昵称可以为中文，英文，数字，尽量不要包含特殊符号与空格)</small>
      </div>
    </div>
         <div class="form-group">
		    ...
		    <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">微信免挂</label>
                     <div class="col-sm-9">
                     <select class="form-control" name="wxcornzt" lay-skin="switch" id="wxcornzt" default="1">
...
<div class="col-sm-9">
	<div class="form-group">
			<div style="width: 100%; margin: 0;"><input type="submit" name="submit" value="确定修改" class="btn btn-block btn-info"/><br/>
</div>
    </div>
  </div>
