...
$cookie=$userrow['alicookie1'];//这里输入你的抓取的登录cookokie
...
if ($sbee == $zqlf) {
    echo "yes";
    file_get_contents("http://".$_SERVER['HTTP_HOST']."/appapi.php?act=Mcode_notify&authuser=sksappconfig&type=ALIPAY&pid=$id&key=$key&money=$lf");//提交支付成功状态码
}
else {
