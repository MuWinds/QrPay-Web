...
if($act=='Get_QrUrl'){//提交获取二维码二请求
	$result = get_curl('http://cookie.codepay9.cn/Cookies_Api.php?act=Get_QrUrl&type=qqpay');
	...
	if($json['cookie']){
		...
		$result=array("code"=>$json['code'],"msg"=>$json['msg'],"id"=>$json['id'],"cookie"=>$json['cookie']);
	}else{
